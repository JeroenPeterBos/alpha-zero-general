...
class CatanNNet(nn.Module):
    def __init__(self, game, args):
        ...
        #self.lin2 = nn.Linear(min_width * 2, min_width * 2)
        #self.lin3a = nn.Linear(min_width * 2, min_width * 2)
        #self.lin3b = nn.Linear(min_width * 2, min_width * 2)
        self.lin4a = nn.Linear(min_width * 2, self.action_size)
        self.lin4b = nn.Linear(min_width * 2, 1)
